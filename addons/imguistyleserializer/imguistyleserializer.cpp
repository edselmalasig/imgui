...
bool ResetStyle(int styleEnum,ImGuiStyle& style) {
  ...
  style.Colors[ImGuiCol_WindowBg]               = ImVec4(0.13f, 0.13f, 0.13f, 0.94f);
  style.Colors[ImGuiCol_ChildBg]                = ImVec4(0.11f, 0.11f, 0.11f, 0.00f);
  style.Colors[ImGuiCol_PopupBg]                = ImVec4(0.08f, 0.08f, 0.08f, 0.94f);
  style.Colors[ImGuiCol_Border]                 = ImVec4(0.43f, 0.43f, 0.50f, 0.50f);
  style.Colors[ImGuiCol_BorderShadow]           = ImVec4(0.00f, 0.00f, 0.00f, 0.00f);
  style.Colors[ImGuiCol_FrameBg]                = ImVec4(0.18f, 0.62f, 0.98f, 0.54f);
  style.Colors[ImGuiCol_FrameBgHovered]         = ImVec4(0.62f, 0.31f, 0.62f, 0.40f);
  style.Colors[ImGuiCol_FrameBgActive]          = ImVec4(0.68f, 0.26f, 0.98f, 0.67f);
  style.Colors[ImGuiCol_TitleBg]                = ImVec4(0.16f, 0.15f, 0.15f, 1.00f);
  style.Colors[ImGuiCol_TitleBgActive]          = ImVec4(0.25f, 0.60f, 0.80f, 1.00f);
  style.Colors[ImGuiCol_TitleBgCollapsed]       = ImVec4(0.00f, 0.00f, 0.00f, 0.51f);
  style.Colors[ImGuiCol_MenuBarBg]              = ImVec4(0.14f, 0.14f, 0.14f, 1.00f);
  style.Colors[ImGuiCol_ScrollbarBg]            = ImVec4(0.35f, 0.81f, 0.98f, 0.53f);
  style.Colors[ImGuiCol_ScrollbarGrab]          = ImVec4(0.51f, 0.51f, 0.51f, 1.00f);
  style.Colors[ImGuiCol_ScrollbarGrabHovered]   = ImVec4(0.41f, 0.41f, 0.41f, 1.00f);
  style.Colors[ImGuiCol_ScrollbarGrabActive]    = ImVec4(0.51f, 0.51f, 0.51f, 1.00f);
  style.Colors[ImGuiCol_CheckMark]              = ImVec4(0.98f, 0.60f, 0.26f, 1.00f);
  style.Colors[ImGuiCol_SliderGrab]             = ImVec4(0.88f, 0.66f, 0.24f, 1.00f);
  style.Colors[ImGuiCol_SliderGrabActive]       = ImVec4(0.26f, 0.98f, 0.31f, 1.00f);
  style.Colors[ImGuiCol_Button]                 = ImVec4(0.73f, 0.26f, 0.98f, 0.40f);
  style.Colors[ImGuiCol_ButtonHovered]          = ImVec4(0.51f, 0.20f, 0.71f, 1.00f);
  style.Colors[ImGuiCol_ButtonActive]           = ImVec4(0.77f, 0.06f, 0.98f, 1.00f);
  style.Colors[ImGuiCol_Header]                 = ImVec4(0.21f, 0.57f, 0.99f, 0.31f);
  style.Colors[ImGuiCol_HeaderHovered]          = ImVec4(0.17f, 0.59f, 1.00f, 0.81f);
  style.Colors[ImGuiCol_HeaderActive]           = ImVec4(0.26f, 0.59f, 0.98f, 1.00f);
  style.Colors[ImGuiCol_Separator]              = ImVec4(1.00f, 1.00f, 1.00f, 0.50f);
  style.Colors[ImGuiCol_SeparatorHovered]       = ImVec4(0.10f, 0.40f, 0.75f, 0.78f);
  style.Colors[ImGuiCol_SeparatorActive]        = ImVec4(0.10f, 0.40f, 0.75f, 1.00f);
  style.Colors[ImGuiCol_ResizeGrip]             = ImVec4(1.00f, 0.38f, 0.61f, 0.72f);
  style.Colors[ImGuiCol_ResizeGripHovered]      = ImVec4(0.98f, 0.26f, 0.78f, 1.00f);
  style.Colors[ImGuiCol_ResizeGripActive]       = ImVec4(0.26f, 0.59f, 0.98f, 0.95f);
  style.Colors[ImGuiCol_Tab]                    = ImVec4(0.39f, 0.35f, 0.58f, 0.86f);
  style.Colors[ImGuiCol_TabHovered]             = ImVec4(0.56f, 0.59f, 0.98f, 0.80f);
  style.Colors[ImGuiCol_TabActive]              = ImVec4(0.20f, 0.47f, 0.83f, 1.00f);
